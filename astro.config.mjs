                ...
                collections: [{
...

                    {
                        ...
                        fields: [
                            ...
                            { name: 'authorURL', widget: 'string', label: 'Author URL', required: false },
                            { name: 'description', widget: 'string', label: 'Description', required: false },
                            { name: 'body', widget: 'markdown', label: 'Agenda Body' },
                            {
                                name: 'layout',
                                widget: 'select',
                                default: '../../layouts/AgendaKegiatan.astro',
                                options: [
                                    { label: 'Agenda Kegiatan', value: '../../layouts/AgendaKegiatan.astro' },
                                ],
                            },
                        ],
                    },
